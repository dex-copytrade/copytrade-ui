          ...
          <div className="left-wrap br8">
            ...
            <div className="g-df pm bb">
              <ul>
                ...
                <li>累计交易收益<p className="c-green">{data.profitSettlements}</p></li>
            ...
            <div className="g-list pad24">
              <ul className="lh32">
                <li>累计跟单人数<p>{data.copyCount}</p></li>
                <li>累计胜率<p className="c-green">{data.winRate}%</p></li>
                <li>总交易次数<p>{data.totalOrderNums}</p></li>
                <li>盈利次数<p>{data.profitOrderNums}</p></li>
                <li>亏损次数<p>{data.lossOrderNums}</p></li>
